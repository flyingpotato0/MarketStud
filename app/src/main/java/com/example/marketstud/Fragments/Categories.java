...
import com.example.marketstud.databinding.FragmentCategoriesBinding;
...
//    };
//
//    public void verifyStoragePermissions(Categories categories) {
//        // Check if we have write permission
//        int permission = ActivityCompat.checkSelfPermission(categories.getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
//
//        if (permission != PackageManager.PERMISSION_GRANTED) {
//            // We don't have permission so prompt the user
//            ActivityCompat.requestPermissions(categories.getActivity(),
...
//        stp.verifyStoragePermissions(this);
    }
